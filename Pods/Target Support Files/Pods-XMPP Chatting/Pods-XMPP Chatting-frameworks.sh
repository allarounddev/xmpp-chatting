...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$CONFIGURATION_BUILD_DIR/Chatto/Chatto.framework"
  install_framework "$CONFIGURATION_BUILD_DIR/ChattoAdditions/ChattoAdditions.framework"
  ...
  install_framework "$CONFIGURATION_BUILD_DIR/TWMessageBarManager/TWMessageBarManager.framework"
